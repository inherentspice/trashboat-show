...
const rulesData = [
    {
        title: 'Step One',
        description:
            "go to the website (your already here so don't actually do this step, it will create an infinite loop of instructions).",
    },
        ...
        <Layout>
            <Box sx={{ padding: 3 }}>
                ...
                <Typography variant="body1" sx={{ marginBottom: 2 }}>
                    Welcome to Trashboat, a chaotic gameshow with terrible prizes. Today the game is simple: subjective
                    trivia. All the questions are subjective. That means they&apos;re almost impossible to get correct.
                    ...
                    />
                    <DefinitionBox term="Trivia" definition="of little value or importance" />
